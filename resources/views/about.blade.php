  ...
  <section class="section section--alt" id="about">
   <div class="container">
    <div class="section__head">
     <h2>О ресторане</h2>
     <p class="muted">Antalya — это уютный ресторан турецкой кухни с акцентом на качество ингредиентов и традиционные техники приготовления.</p>
    </div>
    <div class="aboutGrid">
     <div class="card">
      <h3>Концепция</h3>
      <p>Мы готовим кебабы на углях, мезе — из свежих овощей и специй, а выпечку — в течение дня небольшими партиями.</p>
      <div class="tags">
