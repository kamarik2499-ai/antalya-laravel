...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'mysql' => [
            'driver' => 'mysql',
            // Railway: MYSQL_URL or split MYSQLHOST, MYSQLPORT, MYSQLUSER, MYSQLPASSWORD, MYSQLDATABASE
            // (Laravel's DB_* are not set unless you map them manually in the app service.)
